...
// Sources: UN WUP 2024 (Pop), NFHS-5 (Sex Ratio, TFR), SRS 2020-22 (IMR, LifeExp, MMR), PLFS 23-24 (Unemp, FLFP), MoSPI/RBI (GSDP per capita)
// Note: popCagr rigorously accounts for both Natural Growth (TFR) AND Net Interstate/International Migration
const STATES_INFO = [
    { name: "Andhra Pradesh", type: "State_Coast", base: { pop: 53.8, area: 162.9, gdp: 3100, lit: 67.4, fLit: 60.0, for: 18.2, urb: 35.0, tfr: 1.7, sexRatio: 1045, imr: 21, lifeExp: 70.3, unemp: 4.1, flfp: 45.0, ger: 37.7, popCagr: 0.005, rel: { h: 90.8, m: 7.3, c: 1.4, s: 0.0, o: 0.5 } } },
    { name: "Arunachal Pradesh", type: "State_NE", base: { pop: 1.7, area: 83.7, gdp: 2800, lit: 65.4, fLit: 59.5, for: 79.3, urb: 22.9, tfr: 1.7, sexRatio: 938, imr: 36, lifeExp: 67.5, unemp: 5.5, flfp: 35.0, ger: 30.5, popCagr: 0.008, rel: { h: 29.0, m: 1.9, c: 30.3, s: 0.2, o: 38.6 } } },
    { name: "Assam", type: "State_NE", base: { pop: 36.3, area: 78.4, gdp: 2050, lit: 72.2, fLit: 66.3, for: 36.1, urb: 15.0, tfr: 1.9, sexRatio: 1012, imr: 36, lifeExp: 66.8, unemp: 6.1, flfp: 32.5, ger: 17.1, popCagr: 0.009, rel: { h: 58.5, m: 37.5, c: 3.8, s: 0.1, o: 0.1 } } },
    { name: "Bihar", type: "State_Plains", base: { pop: 135.5, area: 94.1, gdp: 1150, lit: 70.9, fLit: 60.5, for: 7.8, urb: 12.5, tfr: 2.98, sexRatio: 1090, imr: 27, lifeExp: 69.5, unemp: 6.0, flfp: 15.5, ger: 17.1, popCagr: 0.011, rel: { h: 81.0, m: 18.5, c: 0.1, s: 0.0, o: 0.4 } } }, // Massive out-migration tempers high TFR
    { name: "Chhattisgarh", type: "State_Central", base: { pop: 31.0, area: 135.1, gdp: 2150, lit: 70.3, fLit: 60.2, for: 41.1, urb: 23.2, tfr: 2.1, sexRatio: 1015, imr: 38, lifeExp: 65.2, unemp: 3.5, flfp: 55.4, ger: 19.5, popCagr: 0.009, rel: { h: 93.3, m: 2.0, c: 1.9, s: 0.3, o: 2.5 } } },
    { name: "Delhi", type: "UT_Metro", base: { pop: 33.5, area: 1.48, gdp: 6000, lit: 86.2, fLit: 82.4, for: 13.2, urb: 97.5, tfr: 1.5, sexRatio: 913, imr: 14, lifeExp: 75.8, unemp: 5.1, flfp: 25.4, ger: 47.6, popCagr: 0.018, rel: { h: 80.5, m: 14.2, c: 0.9, s: 3.2, o: 1.2 } } }, // Low TFR but massive in-migration
    { name: "Goa", type: "State_Coast", base: { pop: 1.6, area: 3.7, gdp: 7500, lit: 88.7, fLit: 84.6, for: 33.1, urb: 62.2, tfr: 1.3, sexRatio: 973, imr: 5, lifeExp: 73.3, unemp: 9.5, flfp: 28.0, ger: 33.0, popCagr: 0.006, rel: { h: 66.1, m: 8.3, c: 25.1, s: 0.1, o: 0.4 } } },
    { name: "Gujarat", type: "State_Coast", base: { pop: 73.5, area: 196.0, gdp: 4600, lit: 78.0, fLit: 69.7, for: 7.5, urb: 45.0, tfr: 1.9, sexRatio: 919, imr: 23, lifeExp: 70.2, unemp: 2.2, flfp: 33.5, ger: 24.1, popCagr: 0.012, rel: { h: 88.6, m: 9.7, c: 0.5, s: 0.1, o: 1.1 } } }, // Heavy industrial in-migration
    { name: "Haryana", type: "State_North", base: { pop: 31.0, area: 44.2, gdp: 4600, lit: 75.5, fLit: 65.9, for: 3.6, urb: 38.0, tfr: 1.9, sexRatio: 926, imr: 27, lifeExp: 69.4, unemp: 6.1, flfp: 20.2, ger: 32.0, popCagr: 0.013, rel: { h: 87.5, m: 7.0, c: 0.2, s: 4.9, o: 0.4 } } },
    { name: "Himachal Pradesh", type: "State_Hill", base: { pop: 7.8, area: 55.6, gdp: 3250, lit: 82.8, fLit: 76.6, for: 27.7, urb: 10.0, tfr: 1.6, sexRatio: 1040, imr: 17, lifeExp: 72.6, unemp: 4.0, flfp: 52.5, ger: 43.1, popCagr: 0.005, rel: { h: 95.2, m: 2.2, c: 0.2, s: 1.2, o: 1.2 } } },
    { name: "Jammu & Kashmir", type: "UT_Hill", base: { pop: 14.0, area: 42.2, gdp: 2150, lit: 67.1, fLit: 56.4, for: 39.0, urb: 27.0, tfr: 1.6, sexRatio: 889, imr: 20, lifeExp: 73.5, unemp: 7.2, flfp: 25.0, ger: 24.0, popCagr: 0.008, rel: { h: 28.4, m: 68.3, c: 0.2, s: 1.8, o: 1.3 } } },
    { name: "Jharkhand", type: "State_Central", base: { pop: 41.5, area: 79.7, gdp: 1350, lit: 66.4, fLit: 55.4, for: 29.7, urb: 24.1, tfr: 2.26, sexRatio: 1050, imr: 25, lifeExp: 67.1, unemp: 3.1, flfp: 35.2, ger: 18.6, popCagr: 0.010, rel: { h: 67.8, m: 14.5, c: 4.3, s: 0.2, o: 13.2 } } },
    { name: "Karnataka", type: "State_South", base: { pop: 69.5, area: 191.7, gdp: 4800, lit: 75.4, fLit: 68.1, for: 20.1, urb: 41.0, tfr: 1.7, sexRatio: 1034, imr: 19, lifeExp: 69.5, unemp: 3.2, flfp: 38.5, ger: 36.2, popCagr: 0.010, rel: { h: 84.0, m: 12.9, c: 1.9, s: 0.1, o: 1.1 } } }, // Heavy IT in-migration
    { name: "Kerala", type: "State_South", base: { pop: 35.8, area: 38.8, gdp: 4100, lit: 96.2, fLit: 95.2, for: 54.4, urb: 47.7, tfr: 1.5, sexRatio: 1121, imr: 4, lifeExp: 75.2, unemp: 7.0, flfp: 25.5, ger: 43.2, popCagr: 0.002, rel: { h: 53.5, m: 28.5, c: 17.5, s: 0.0, o: 0.5 } } }, // Extremely low growth (Out-migration + Low TFR)
    { name: "Madhya Pradesh", type: "State_Central", base: { pop: 89.0, area: 308.2, gdp: 1850, lit: 69.3, fLit: 59.2, for: 25.1, urb: 28.5, tfr: 2.0, sexRatio: 956, imr: 41, lifeExp: 67.0, unemp: 3.0, flfp: 45.2, ger: 28.9, popCagr: 0.011, rel: { h: 90.9, m: 6.6, c: 0.3, s: 0.2, o: 2.0 } } },
    { name: "Maharashtra", type: "State_West", base: { pop: 133.5, area: 307.7, gdp: 3850, lit: 82.3, fLit: 75.9, for: 16.5, urb: 47.0, tfr: 1.7, sexRatio: 966, imr: 15, lifeExp: 72.7, unemp: 3.1, flfp: 35.0, ger: 35.3, popCagr: 0.010, rel: { h: 79.8, m: 11.5, c: 1.0, s: 0.2, o: 7.5 } } }, // Low TFR offset by massive in-migration
    ...
    { name: "Meghalaya", type: "State_NE", base: { pop: 3.5, area: 22.4, gdp: 1550, lit: 74.4, fLit: 72.8, for: 76.0, urb: 20.0, tfr: 2.9, sexRatio: 989, imr: 29, lifeExp: 68.5, unemp: 4.0, flfp: 45.0, ger: 20.0, popCagr: 0.013, rel: { h: 11.5, m: 4.4, c: 74.5, s: 0.1, o: 9.5 } } },
    { name: "Mizoram", type: "State_NE", base: { pop: 1.3, area: 21.0, gdp: 3200, lit: 91.3, fLit: 89.2, for: 85.0, urb: 52.0, tfr: 2.2, sexRatio: 976, imr: 15, lifeExp: 72.0, unemp: 5.5, flfp: 55.0, ger: 24.0, popCagr: 0.010, rel: { h: 2.7, m: 1.3, c: 87.1, s: 0.0, o: 8.9 } } },
    { name: "Nagaland", type: "State_NE", base: { pop: 2.3, area: 16.5, gdp: 2000, lit: 79.5, fLit: 76.1, for: 75.0, urb: 28.0, tfr: 2.4, sexRatio: 931, imr: 25, lifeExp: 69.5, unemp: 8.0, flfp: 42.0, ger: 18.0, popCagr: 0.011, rel: { h: 8.7, m: 2.5, c: 87.9, s: 0.1, o: 0.8 } } },
    ...
    { name: "Punjab", type: "State_North", base: { pop: 31.5, area: 50.3, gdp: 3100, lit: 75.8, fLit: 70.7, for: 3.7, urb: 40.0, tfr: 1.6, sexRatio: 938, imr: 18, lifeExp: 72.7, unemp: 6.1, flfp: 22.0, ger: 30.1, popCagr: 0.004, rel: { h: 38.5, m: 1.9, c: 1.3, s: 57.7, o: 0.6 } } }, // Massive international out-migration
    { name: "Rajasthan", type: "State_West", base: { pop: 84.5, area: 342.2, gdp: 2300, lit: 66.1, fLit: 52.1, for: 4.8, urb: 26.0, tfr: 2.4, sexRatio: 1009, imr: 32, lifeExp: 69.0, unemp: 4.0, flfp: 42.5, ger: 25.0, popCagr: 0.012, rel: { h: 88.5, m: 9.1, c: 0.1, s: 1.3, o: 1.0 } } },
    { name: "Sikkim", type: "State_NE", base: { pop: 0.7, area: 7.0, gdp: 7000, lit: 81.4, fLit: 76.4, for: 47.1, urb: 25.2, tfr: 1.1, sexRatio: 890, imr: 5, lifeExp: 73.1, unemp: 4.5, flfp: 41.2, ger: 28.0, popCagr: 0.004, rel: { h: 57.8, m: 1.6, c: 9.9, s: 0.3, o: 30.4 } } },
    { name: "Tamil Nadu", type: "State_South", base: { pop: 78.5, area: 130.0, gdp: 4700, lit: 80.1, fLit: 73.4, for: 20.3, urb: 51.0, tfr: 1.4, sexRatio: 1088, imr: 13, lifeExp: 72.6, unemp: 3.5, flfp: 40.5, ger: 47.0, popCagr: 0.006, rel: { h: 87.6, m: 5.9, c: 6.1, s: 0.1, o: 0.3 } } }, // Low TFR fully offset by industrial in-migration
    { name: "Telangana", type: "State_South", base: { pop: 39.5, area: 112.0, gdp: 4800, lit: 66.5, fLit: 57.9, for: 24.0, urb: 45.0, tfr: 1.8, sexRatio: 1049, imr: 21, lifeExp: 69.6, unemp: 4.2, flfp: 35.5, ger: 39.1, popCagr: 0.009, rel: { h: 85.1, m: 12.7, c: 1.3, s: 0.1, o: 0.8 } } },
    { name: "Tripura", type: "State_NE", base: { pop: 4.2, area: 10.4, gdp: 2500, lit: 87.2, fLit: 82.7, for: 60.0, urb: 26.0, tfr: 1.7, sexRatio: 960, imr: 21, lifeExp: 71.0, unemp: 5.0, flfp: 30.0, ger: 22.0, popCagr: 0.008, rel: { h: 83.4, m: 8.6, c: 4.3, s: 0.0, o: 3.7 } } },
    { name: "Uttar Pradesh", type: "State_Plains", base: { pop: 243.0, area: 240.9, gdp: 1350, lit: 73.0, fLit: 61.0, for: 6.1, urb: 24.0, tfr: 2.4, sexRatio: 1017, imr: 38, lifeExp: 65.6, unemp: 3.5, flfp: 20.5, ger: 24.1, popCagr: 0.010, rel: { h: 79.0, m: 20.2, c: 0.2, s: 0.3, o: 0.3 } } }, // Massive out-migration
    { name: "Uttarakhand", type: "State_Hill", base: { pop: 12.0, area: 53.4, gdp: 3500, lit: 78.8, fLit: 70.0, for: 45.0, urb: 30.2, tfr: 1.9, sexRatio: 963, imr: 26, lifeExp: 71.5, unemp: 5.5, flfp: 35.0, ger: 35.0, popCagr: 0.009, rel: { h: 82.9, m: 13.9, c: 0.3, s: 2.3, o: 0.6 } } },
    { name: "West Bengal", type: "State_East", base: { pop: 104.0, area: 88.7, gdp: 2100, lit: 76.3, fLit: 70.5, for: 19.0, urb: 33.0, tfr: 1.6, sexRatio: 1049, imr: 19, lifeExp: 72.1, unemp: 4.8, flfp: 25.5, ger: 21.0, popCagr: 0.006, rel: { h: 68.5, m: 29.5, c: 0.7, s: 0.1, o: 1.2 } } }
];
